            ...
            <div>
                  <div className='flex  items-center gap-4 my-4'>
                      ...
                      <div className='text-sm'>
                        ...
                        <p>Get your order swiftly delivered to your doorstep from the nearest dark store.</p>
                      </div>
                  </div>
                  <div className='flex  items-center gap-4 my-4'>
                      <img
                      ...
                      <div className='text-sm'>
                        ...
                        <p>Your go-to destination for the best prices and exclusive offers straight from the manufacturers.</p>
                      </div>
                  </div>
                  <div className='flex  items-center gap-4 my-4'>
                      <img
                      ...
                      <div className='text-sm'>
                        ...
                        <p>Explore 5000+ products spanning food, personal care, household essentials, and more.</p>
                      </div>
                  </div>
            </div>
